...
import java.util.Random;
    ...
    Description:
    This creates 100 randomly generated address (coordinates) for the sandwich truck and puts them into a file called
    "Houses.txt".
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 100; i++) { // Replace the number after "i < " for many addresses you want
            ...
            int house = (rnd.nextInt(9));
            int block = (rnd.nextInt(8))+1;
            char street2 = (char) ('a' + rnd.nextInt(26));
            String nHouse = String.valueOf(block)+String.valueOf(house+1)+"0"; // adds a 0 to the front of the house number
            //String address = (i+1) +".) (Street 1 (x): " + (street1+1) + ", Street 2 (y): " + street2 + ", House: " + (block+1)+nHouse + ")";
            String ezAddress = "(" + (street1 + 1) + ", " + street2 + ", " + nHouse + ")";
